                ...
                {step === 'success' && (
                    <div className="results-area flex-center" style={{ flexDirection: 'column', padding: '60px 20px' }}>
                        ...
                        <div style={{ marginTop: '60px', width: '100%', maxWidth: '800px', textAlign: 'center' }}>
                            <h3 className="section-title">Take Your Channel to the Next Level</h3>
                            <div className="grid grid-2">
                                <div className="hook-card">
                                    <h4>🚀 30-Day Content Plan</h4>
                                    <p style={{ fontSize: '0.9rem', color: '#888', marginTop: '10px' }}>
                                        Learn how to turn these titles into a full month of content.
                                    </p>
                                </div>
                                <div className="hook-card">
                                    <h4>🎨 Best Thumbnail Tools</h4>
                                    <p style={{ fontSize: '0.9rem', color: '#888', marginTop: '10px' }}>
                                        The tools top creators use to get 10%+ CTR.
                                    </p>
                                </div>
                            </div>
                        </div>
