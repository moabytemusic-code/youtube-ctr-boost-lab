                    ...
                    <div className="results-area flex-center" style={{ flexDirection: 'column', padding: '60px 20px' }}>
                        ...
                        <div style={{ marginTop: '60px', width: '100%', maxWidth: '800px', textAlign: 'center' }}>
                            ...
                            <div className="grid grid-2">
                                <a href="https://www.tubebuddy.com" target="_blank" className="hook-card" style={{ textDecoration: 'none', color: 'inherit', transition: 'transform 0.2s' }}>
                                ...
                                <a href="https://vidiq.com" target="_blank" className="hook-card" style={{ textDecoration: 'none', color: 'inherit', transition: 'transform 0.2s' }}>
                                    <div className="flex-center" style={{ marginBottom: '10px' }}>
                                ...
                                <a href="https://www.epidemicsound.com" target="_blank" className="hook-card" style={{ textDecoration: 'none', color: 'inherit', transition: 'transform 0.2s' }}>
                                    <div className="flex-center" style={{ marginBottom: '10px' }}>
